            ...
            <div class="map-right  col-lg-5  col-sm-12  wow fadeInUp">
                <div class="map-right-wrap">
                    ...
                    <div class="company-info-wrap">
                        <p>address：<?php echo $site['address'];?></p>
                        <p> </p>
                        <p>telephone：<a href="tel:(+86)-18018149584"><?php echo $site['phone'];?></a></p>

                        <p>email：<a href="mailto:848820348@qq.com"><?php echo $site['email'];?></a></p>
                    </div>
...
<section class="message-wrap">
    <h1>Welcome to leave us a message</h1>
    <div class="ly-wrap">
        <form action="<?php echo U('guestbook/index/init');?>" method="post">
            <input type="hidden" value="title" name="title" placeholder="Message subject">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6  col-sm-6">
                    ...
                    <textarea name="bookmsg" value="" class="bookmsg" placeholder="Please leave your information"
                        required></textarea>
                </div>
                ...
                <div class="col-lg-6  col-sm-6">
                    ...
                    <div class="code-wrap">
                        <input name="code" placeholder="Please enter the verification code" required type="text"
                            class="yzm-input-text">
                        <img src="<?php echo U('api/index/code');?>" onclick="this.src=this.src+'?'" class="yzm-code"
                            title="invisibility? Click Replace">
                    </div>
                </div>
                <div class="col-lg-6  col-sm-6">

                    <div>
                        <input type="submit" name="dosubmit" value="Submit" class="yzm-submit">
                    </div>
                </div>
...
<script>
    ...
    <h6 style='margin:0 0 5px 0;'><?php echo $site['site_name'];?></h6>

    <p style='margin:0;line-height:1.5;font-size:13px;'>
        Dongwang Road, Suzhou Industrial Park
    </p>
</div>`;
