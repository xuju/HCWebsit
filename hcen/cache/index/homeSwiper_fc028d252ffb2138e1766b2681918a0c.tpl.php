        ...
        <div class="container">
            <div class="home-types-wrap">
                ...
                <div class="home-types-item  wow fadeInUp" data-delay=".2s">
                    ...
                    <div class="text">Company Honors</div>
                </div>
                ...
                <div class="home-types-item  wow fadeInUp" data-delay=".4s">
                    ...
                    <div class="text">organizational</div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                            <div class="slider__content">
                                ...
                                <h1 swiper-animate-effect="fadeInUp" class="ani" swiper-animate-delay=".1s">
                                ...
                                <div class="home-one-desc ani" swiper-animate-effect="fadeInUp"
                                    ...
                                    <span style="white-space:nowrap;text-indent: 50px;font-size: 16px;">We have the
                                        latest and best
                                        service technology and team</span>
                                </div>
