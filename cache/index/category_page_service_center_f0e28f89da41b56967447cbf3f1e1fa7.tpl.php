...
<section class="service-center" style="padding-top: 60px;">
    <div class="container">
        <div class="service-center-content">
            ...
            <p class="desc">
                为保证准确交货，用户须注意：<br />
                本公司为24小时接单，客户可以通过与我们沟通，提供三维设计图，我们第一时间提供报价与周期，一般模型24小时发货，特殊模型发货时间与客服沟通。
            </p>
            <div class="sub-title">发票说明</div>
            <p class="desc">
                发票的开具<br />
                发票内容名称为：3D打印服务费。<br />
                1.发票将与货物一并邮寄，特殊情况我们客服会与您沟通，敬请大家了解并注意<br />
            ...
            <p class="desc">
                ...
                为了保障交货速度，创毅目前仅支持顺丰速递。不在顺丰配送范围内的订单，将由顺丰公司安排转寄。<br />
