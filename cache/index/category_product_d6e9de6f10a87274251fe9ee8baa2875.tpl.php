            ...
            <div class="col-xl-12">
                ...
                <div class="sidebar__widget mb-50 wow fadeInUp">
                    ...
                    <div class="sidebar__widget-content submenu-wrap">
                        <div class="tags">
                            <a href="<?php echo get_category($catid, 'pclink' );?>" class="active">全部</a>
                            <?php if(is_array($r)) foreach($r as $v) { ?>

                            <a href="<?php echo get_category($v['catid'], 'pclink');?>"><?php echo $v['catname'];?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="portfolio__load mt-25">
                    ...
                    <div class="basic-pagination wow fadeInUp" data-wow-delay=".2s">
                        <?php
                         $str=$pages;
