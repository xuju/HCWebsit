...
<section class="portfolio__area pt-110 pb-160">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php $top_id=get_category($parentid, 'parentid')?>
            <?php if($top_id) { ?>
            <div class="col-xl-12">
                <div class="portfolio__menu mb-40 wow fadeInUp">
                    ...
                    <?php $r = get_childcat(get_category($parentid, 'parentid'));?>
                    <div class="masonary-menu filter-button-group d-sm-inline-block">
                        ...
                        <?php $top=get_category($v['catid'],'parentid');?>
                        <?php $parentid?>
                        <a href="<?php echo get_category($v['catid'], 'pclink');?>" <?php if($v['catid']==$parentid) { ?>
                            class="button  active" <?php } else { ?> class="button " <?php } ?>><?php echo $v['catname'];?></a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="sidebar__widget-content">
                        <div class="cat-link">
                            <ul>
                                ...
                                <li><a <?php if($v['catid']==$catid) { ?> class="active" <?php } else { ?> class="" <?php } ?>
                                        href="<?php echo get_category($v['catid'], 'pclink');?>"><?php echo $v['catname'];?></a></li>
