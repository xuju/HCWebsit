        ...
        <div class="footer__top  ani">
            <div class="container">
                <div class="footer-top">
                    ...
                    <div class="footer-top-item">
                        <div class="footer-item-left">
                            <img src="<?php echo STATIC_URL;?>company/images/location.png" alt="地址">
                        </div>
                        <div class="footer-item-right">
                    ...
                    <div class="footer-top-item">
                        <div class="footer-item-left">
                            <img src="<?php echo STATIC_URL;?>company/images/email.png" alt="邮箱">
                        </div>
                        <div class="footer-item-right">
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6">
                        <div class="footer__widget mb-45  ani " swiper-animate-delay=".2s">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="footer__copyright-text">
                            <p>&copy;
                                京ICP证030173号京网文|2013|0934-983号 Copyright ©2022 Baidu
                            </p>
                        </div>
                    </div>
