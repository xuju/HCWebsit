    ...
    <div class="container  production-wrap">
        <div class="row">
            ...
            <div class="col-lg-3 list-width">
                ...
                <?php $data = get_childcat(get_category($catid, 'parentid'));?>
                <ul class="category-wrap wow fadeInUp">
                    <a href="<?php echo get_category($parentid, 'pclink');?>">
                        部分产品展示图
                    </a>
                    ...
                    <a <?php if($catid===$v[catid]) { ?> class="select" <?php } ?> href="<?php echo $v['pclink'];?>">
                        <?php echo $v['catname'];?>
                    </a>
                    <?php } ?>
                </ul>
